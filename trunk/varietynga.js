...
varietynga_weibo_ajax.tf = function(mode){
	...
	if(mode){
		oo._.__add(
			_$('/a').$0(
				'href','javascript:void(0)',
				'innerHTML','完毕<img src="http://ngaplugins.salikx.com/svn/trunk/progressIndicator16x16.gif" style="height:12px;">',
...
function varietynga_weibo_scroll(check,tfunc){
	if(check){
		...
		oo._.__add(
			_$('/a').$0(
				'href','javascript:void(0)',
				'innerHTML','正在加载<img src="http://ngaplugins.salikx.com/svn/trunk/progressIndicator16x16.gif" style="height:12px;">',
				'title','正在加载后面的页面，请稍候...',
				'className','darkred'
			)
		)
...
function varietynga_Initialization(){
	...
	//x.innerHTML = ".varietynga_cur_zin{cursor: url(http://ngaplugins.salikx.com/svn/trunk/img/cur_zin.cur) 14 14,pointer;}.varietynga_cur_zout{cursor: url(http://ngaplugins.salikx.com/svn/trunk/img/cur_zout.cur) 14 14,pointer;}";
...
var elimg = document.getElementById(arg).parentNode.getElementsByTagName("img")[0];
	...
	if (postimg.length == 0){
		...
		//elimg.parentNode.removeChild(elimg);
		elimg.src = "http://ngaplugins.salikx.com/svn/trunk/img/yes.png";
		elimg.title = "该帖有图片。";
...
function varietynga_search(){
	...
	w = _$('<div class="urltip urltip2" style="margin:0;height:16px;line-height:16px" id="selectTextHintWindow" onmouseup="commonui.cancelBubble(event)">\
		...
		&nbsp; &nbsp;<a href="javascript:void(0)" onclick="commonui.quoteTo.baidu()" title="百度一下" target="_blank" class="inlineBlock" style="background:url(http://ngaplugins.salikx.com/svn/trunk/img/baidu.png);width:16px;height:16px"></a>\
		&nbsp;<a href="javascript:void(0)" onclick="commonui.quoteTo.google()" title="谷歌搜索" target="_blank" class="inlineBlock" style="background:url(http://ngaplugins.salikx.com/svn/trunk/img/google.png);width:16px;height:16px"></a>\
	...
	for (var i=0;i<timg.length;i++){
		if (checkimg(timg[i])){
			...
			ts.innerHTML = "<div style='position: absolute;z-index:999'>\r\
				...
				style='display: inline-block; background-image: url(http://ngaplugins.salikx.com/svn/trunk/img/left.gif); \
				...
				style='display: inline-block; background-image: url(http://ngaplugins.salikx.com/svn/trunk/img/right.gif); \
