...
loader.css("http://ngaplugins.salikx.com/svn/trunk/editor/editor.css"); //加载CSS
				...
				for (var k=0;k<nga_plug_mojo[i].data.length;k++){
					if (nga_plug_mojo[i].data[k].check || i == 0){
						...
						for (var l=0;l<nga_plug_mojo[i].data[k].img.length;l++){
							...
							if (i>1) s += '<div onclick="event.cancelBubble = true;nga_edit_mojo(\'click\',this,\'add\');" title="把这个表情添加到自定义表情" style="display:none;position: absolute;background: url(\'http://ngaplugins.salikx.com/svn/trunk/img/add.png\');height:15px;width:15px;border-right:1px solid #777;border-bottom:1px solid #777;"></div>';
							if (i==1) s += '<div onclick="event.cancelBubble = true;nga_edit_mojo(\'click\',this,\'del\');" title="从自定义表情中删除这个表情" style="display:none;position: absolute;background: url(\'http://ngaplugins.salikx.com/svn/trunk/img/del.png\');height:15px;width:15px;border-right:1px solid #777;border-bottom:1px solid #777;"></div>';
						...
						if (i==1){
							...
							s += '<img style="width:40px;height:40px;" src="http://ngaplugins.salikx.com/svn/trunk/img/add1.png"></div>';
						}
